...
export interface SalesOrderListItem { id: string; number: string; customerName: string; status: SalesOrderStatus; orderDate: string; total: number; }
...
export interface PurchaseOrderListItem { id: string; number: string; supplierName: string; status: PurchaseOrderStatus | string; orderDate: string; total: number; }
