...
export function Sidebar({ permissions, open = false, onClose, userEmail }: SidebarProps) {
  ...
  const sidebarContent = <aside className="flex h-full w-[260px] flex-col bg-[#123B2A] text-white select-none">
    ...
    <div className="px-5 py-2"><div className="flex items-center justify-between rounded-xl border border-white/10 bg-white/[0.06] px-3.5 py-2.5 text-xs text-[#D5E6DC]"><div className="flex items-center gap-2.5"><Building2 size={15} className="text-[#8EE04E]" /><div><div className="text-[9px] font-bold uppercase tracking-wider text-[#7EAC95]">Workspace</div><div className="font-semibold text-white">Main Organization</div></div></div><ChevronRight size={13} className="text-[#7EAC95]" /></div></div>
