  ...
  return (
    <div className="min-h-screen bg-[#F5F7F5] lg:flex">
      ...
      <div className="min-w-0 flex-1">
        <Topbar
          breadcrumb={BREADCRUMBS[pathname ?? ""] ?? "NEXORA"}
          userEmail={me.email}
          onMenuClick={() => setMenuOpen(true)}
        />
        <main key={pathname} className="min-h-[calc(100vh-70px)] px-4 py-6 sm:px-6 lg:px-8 lg:py-7">
          <div className="mx-auto w-full max-w-[1440px] animate-content-in">
            {children}
          </div>
        </main>
      </div>
